...
export class MikroFieldMapper<Domain, DBEntity extends object> implements IMapper<Domain, DBEntity> {
  private readonly domainToDB: Map<string, string>
  private readonly dbToDomain: Map<string, string>

  public constructor(
    private readonly EntityClass: new () => DBEntity,
    fieldMap: FieldMapping<Domain, DBEntity>
  ) {
